...
namespace oficinaCovid.App.Persistencia.Migrations
{
    ...
    [Migration("20211001035931_Segunda")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("oficinaCovid.App.Dominio.Administrativo_Oficina", b =>
                {
                    ...
                    b.ToTable("Administrativos_Oficinas");
                });

            modelBuilder.Entity("oficinaCovid.App.Dominio.Aseador_Sede", b =>
                {
                    b.Property<int?>("AseadorId")
                        .HasColumnType("int");

                    b.Property<int?>("SedeId")
                        .HasColumnType("int");

                    b.HasIndex("AseadorId");

                    b.HasIndex("SedeId");

                    b.ToTable("Aseadores_Sedes");
                });
            ...
            modelBuilder.Entity("oficinaCovid.App.Dominio.Proveedor_Sede", b =>
                {
            ...
            modelBuilder.Entity("oficinaCovid.App.Dominio.Administrativo_Oficina", b =>
                {
                    b.HasOne("oficinaCovid.App.Dominio.Administrativo", "Administrativo")
                        .WithMany()
            ...
            modelBuilder.Entity("oficinaCovid.App.Dominio.Aseador_Sede", b =>
                {
                    b.HasOne("oficinaCovid.App.Dominio.Aseador", "Aseador")
                        .WithMany()
                        .HasForeignKey("AseadorId");

                    b.HasOne("oficinaCovid.App.Dominio.Sede", "Sede")
                        .WithMany()
                        .HasForeignKey("SedeId");

                    b.Navigation("Aseador");
            ...
            modelBuilder.Entity("oficinaCovid.App.Dominio.Proveedor_Sede", b =>
                {
                    b.HasOne("oficinaCovid.App.Dominio.Proveedor", "Proveedor")
                        .WithMany()
